                    ...
                    <div class="template-demo">
                        <form method="POST" action="/donasi/update/{{ $donasi->id }}"  enctype="multipart/form-data">
                                ...
                                <select class="form-select" name="id_donatur" id="">
                                    ...
                                    @foreach ($donatur as $donatur)
                                        <option value="{{ $donatur->id }}"
                                            @if ($donatur->id == $donasi->id_donatur) selected="" @endif>{{ $donatur->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="jumlah" value="{{ $donasi->jumlah }}" class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kota" value="{{ $donasi->kota }}" class="form-control"
                                    id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Provinsi</label>
                                <input type="text" name="provinsi" value="{{ $donasi->provinsi }}" class="form-control"
                                    id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
