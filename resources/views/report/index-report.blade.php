                    ...
                    <div class="col-md-12 d-flex ml-3 mt-3" style="">
                        ...
                        <div class="col-md-12 d-flex justify-content-end">
                            <div class="col-sm-2 mr-2">
                                <input type="text" onfocus="(this.type = 'date')" placeholder="Start date" @if(isset($startDate))value="{{$startDate}}"@endif name="startDate" class="form-control" id="startDate">
                            </div>

                            <div class="col-sm-2 mr-2">
                                <input type="text" onfocus="(this.type = 'date')" @if(isset($endDate))value="{{$endDate}}"@endif name="endDate" class="form-control" placeholder="End Date" id="endDate">
                            </div>
